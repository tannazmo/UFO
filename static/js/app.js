...
function updateFilters() {
    ...
    console.log (`changed_element is ${changed_element}`);
    // 4b. Save the value that was changed as a variable.
    var changed_value = d3.select(this).property("value");
    console.log (`changed_value is ${changed_value}`);
  ...
  if (changed_value !== undefined){
    filters[filterId] = changed_value;
    console.log(filters);
  }
  else {
